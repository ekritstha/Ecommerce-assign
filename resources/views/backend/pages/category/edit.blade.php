                    ...
                    <form role="form" action="{{ route('admin.'.$page.'.update', $data->id) }}" method="post"
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="slug" class="form-control" value="name" required>
                                @error('name')
                            ...
                            <div class="form-group">
                                <label for="start_price">Starting Price {!! \App\Util\Util::htmlReq() !!}</label>
                                <input type="number" class="form-control" id="start_price" name="start_price" value="{{$data->start_price}}" required>
                                @error('start_price')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
