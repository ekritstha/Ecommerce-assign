                    ...
                    <form role="form" action="{{ route('admin.'.$page.'.update', $data->id) }}" method="post"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="textarea @error('description') is-invalid @enderror" id="editor1" name="description" required>
                                  {!! $data->description !!}
                                </textarea>
                                @error('description')
                                <div class="alert alert-danger">{{ $message }}</div>
                            ...
                            <div class="form-group">
                                ...
                                <select id="exampleInputFile" class="form-control" name="category">
                                  ...
                                  @foreach(\App\Util\Util::getCategories() as $category)
                                    <option value="{{$category->id}}" {{ $category->id==$data->category?'selected':'' }}>{{$category->name}}</option>
                                  @endforeach
                                </select>
                              </div>
                        </div>
